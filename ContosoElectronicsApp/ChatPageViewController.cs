...
namespace ContosoElectronics
{
    ...
    public class ChatPageViewController : MessagesViewController
    {
        ...
        string DirectLineKey = "DIRECT_LINE_SECRET_KEY";

        //Tracking of which user said what
        User sender = new User { Id = "2CC8343", DisplayName = "You" };
        User friend = new User { Id = "BADB229", DisplayName = "Megan (Bot)" };
        ...
        public override async void ViewDidLoad()
        {
            ...
            messages.Add(new Message(friend.Id, friend.DisplayName, NSDate.DistantPast, "Welcome to the Contoso Electronics Shop!"));
        ...
        public override async void PressedSendButton(UIButton button, string text, string senderId, string senderDisplayName, NSDate date)
        {
            ...
            {
                if (ms.messages[messageCount].from == "BOTHANDLER")
                {
